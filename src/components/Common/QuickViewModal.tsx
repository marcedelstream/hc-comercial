                ...
                <div className="max-w-[445px] w-full">
                  {product.discountedPrice &&
                    product.discountedPrice < product.price && (
                      <span className="inline-block text-custom-xs uppercase rounded-full font-medium text-dark py-1 px-3 bg-blue mb-6.5">
                        {Math.round(
                    ...
                    <div className="flex items-center gap-2">
                      {product.quantity > 0 ? (
                        <>
                          ...
                          <span className="text-dark"> En stock </span>
                        </>
                      ) : (
                        <>
                          <CircleCheckIcon className="fill-red" />
                          <span className="text-body"> Sin stock </span>
                        </>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    <button
                      ...
                      className="inline-flex py-3 font-medium text-dark duration-200 ease-out rounded-lg bg-blue px-7 hover:bg-blue-dark"
                    >
