        ...
        <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 sticky bottom-0 mt-auto">
          ...
          <div className="flex items-center gap-4">
            <Link
              onClick={() => handleCartClick()}
              href="/cart"
              className="flex justify-center w-full px-6 py-3 text-base font-semibold text-dark duration-200 ease-out rounded-lg bg-blue hover:bg-blue-dark"
            >
              Ver carrito
            </Link>
            ...
            <button
              ...
              className="flex justify-center w-full px-6 py-3 text-base font-semibold text-white duration-200 ease-out rounded-lg bg-dark hover:bg-opacity-95"
            >
              Finalizar compra
            </button>
          </div>
