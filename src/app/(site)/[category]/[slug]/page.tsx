    ...
    <div className="pt-6 sm:pt-10 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          {/* Imagen */}
          <div className="bg-gray-2 rounded-2xl flex flex-col items-center justify-center min-h-[400px] overflow-hidden">
            {imgUrl ? (
              // eslint-disable-next-line @next/next/no-img-element
              <img src={imgUrl} alt={product.title} className="w-full h-full object-contain p-6" />
            ) : (
              <>
